...
- **仍开**：内联引用 chip 设计未决；MiniCalendar/TabBar 宽 28、FinderToolbar 视觉 40、WorkbenchSidebar 桌面壳分区头、翻译 COARSE_HIT 图标为有意折衷/#161；debug-panel 主工具栏已基本扫完，生产路径残留见 ROUND-66-FIXES.md。
