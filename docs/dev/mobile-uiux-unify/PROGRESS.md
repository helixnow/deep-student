...
- 继续扫生产路径残留（见 ROUND-83-FIXES.md）；项目级 SegmentedControl 生产调用处已基本补完 `!min-h-11`
...
- Round 41–83：DEV debug-panel 插件工具栏几乎扫完；生产路径触控残留见 ROUND-83 队列
