...
- 继续扫生产路径残留（见 ROUND-82-FIXES.md）；优先补仍缺 `!min-h-11` 的 SegmentedControl 调用处
...
- Round 41–82：DEV debug-panel 插件工具栏几乎扫完；生产路径触控残留见 ROUND-82 队列
