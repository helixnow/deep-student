...
- 继续扫生产路径残留（见 ROUND-84-FIXES.md）；`hover: none and coarse` 的命中洞已收一波，剩余多为藏键盘提示
...
- Round 41–84：DEV debug-panel 插件工具栏几乎扫完；生产路径触控残留见 ROUND-84 队列
