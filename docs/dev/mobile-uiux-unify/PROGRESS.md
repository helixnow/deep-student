...
- 继续扫生产路径残留（见 ROUND-89-FIXES.md）；`deep-student.css` !important 小尺寸基线、疑似死 CSS、Label/`<summary>` 漏网
- 下一轮每个 fable 仍须整区域多洞，禁止一人一行
...
- Round 41–89：DEV debug-panel 插件工具栏几乎扫完；生产路径触控残留见 ROUND-89 队列
