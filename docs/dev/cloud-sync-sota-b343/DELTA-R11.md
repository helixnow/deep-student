...
2026-08-24 在本 Cloud Agent（Linux 6.12.94+ / Python 3.12.3）实跑结果：

| 场景 | ZIP | DSBK v2 | 本地打包 | 10 Mbps 纯上传 | 50 Mbps 纯上传 |
|---|---:|---:|---:|---:|---:|
| 初始快照 | 144.953 MiB | 144.956 MiB | 9.792 s | 121.598 s | 24.320 s |
| 用户数据零变化（只换版本元数据） | 144.953 MiB | 144.956 MiB | 11.122 s | 121.598 s | 24.320 s |
| SQLite 仅一行时间戳变化 | 144.953 MiB | 144.956 MiB | 11.005 s | 121.598 s | 24.320 s |
