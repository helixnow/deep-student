  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', fontSize: 12, fontFamily: 'ui-monospace, monospace' }}>
      ...
      <div style={{ padding: '6px 8px', borderBottom: '1px solid var(--border)', display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <button onClick={handleCopy} title="复制日志" className="[@media(pointer:coarse)]:min-h-11 [@media(pointer:coarse)]:min-w-11" style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '2px 4px', color: copyFeedback ? '#10b981' : '#6b7280' }}>
          <Copy size={14} />
        </button>
        <button onClick={handleDownload} title="下载日志" className="[@media(pointer:coarse)]:min-h-11 [@media(pointer:coarse)]:min-w-11" style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '2px 4px', color: '#6b7280' }}>
          <Download size={14} />
        </button>
        <button onClick={handleClear} title="清空" className="[@media(pointer:coarse)]:min-h-11 [@media(pointer:coarse)]:min-w-11" style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '2px 4px', color: '#6b7280' }}>
          <Trash size={14} />
        </button>
      </div>
