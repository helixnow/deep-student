      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between">
            ...
            <DsButton variant="ghost" size="icon" iconOnly onClick={loadSecurityStatus} disabled={loading} className="!p-1 hover:bg-[var(--overlay-control-hover)] [@media(pointer:coarse)]:!min-h-11 [@media(pointer:coarse)]:!min-w-11" title={t('securityStatus.refresh')} aria-label="refresh">
