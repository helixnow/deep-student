        ...
        <div className="flex flex-wrap items-center gap-1.5 text-[11px] text-muted-foreground">
          ...
          {isCoarsePointer && (
            <DsButton
              ...
              className="flex items-center gap-0.5 text-[11px] text-primary [@media(pointer:coarse)]:!min-h-11"
            >
              {isScopeExpanded ? (
                <>
                  <CaretUp size={10} />
      ...
      {isReasonOpen && !disabled && (
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <DsButton
            ...
            disabled={disabled}
            className="shrink-0 text-xs text-muted-foreground hover:text-destructive [@media(pointer:coarse)]:!min-h-11"
          >
          ...
          <DsButton
            ...
            disabled={disabled}
            className="shrink-0 text-xs text-destructive hover:text-destructive/80 [@media(pointer:coarse)]:!min-h-11"
          >
