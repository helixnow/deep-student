...
impl AssignmentSlot {
    fn parse(value: &str) -> Result<Self, String> {
        match value {
            ...
            "qbank_ai_generation_model_config_id" => Ok(Self::QbankAiGeneration),
    ...
    fn as_str(self) -> &'static str {
        match self {
            ...
            Self::QbankAiGeneration => "qbank_ai_generation_model_config_id",
    ...
    fn current(self, assignments: &ModelAssignments) -> Option<&str> {
        match self {
            ...
            Self::QbankAiGeneration => assignments.qbank_ai_generation_model_config_id.as_deref(),
    ...
    fn set(self, assignments: &mut ModelAssignments, value: Option<String>) {
        match self {
            ...
            Self::QbankAiGeneration => assignments.qbank_ai_generation_model_config_id = value,
