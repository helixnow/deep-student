...
pub static BUILTIN_DESCRIPTORS: &[ToolDescriptor] = &[
    ...
    // —— FsrsSettingsExecutor（2）——
    d("fsrs_get_scheduler_config", Low, true, Read).headless_ptc(),
    d("fsrs_update_scheduler_config", Medium, false, WriteLocal),
...
mod tests {
    ...
    use crate::chat_v2::tools::{
        ...
        FetchExecutor, FileManagerExecutor, FsrsSettingsExecutor, GeneralToolExecutor,
        GenerativeUiExecutor, GitToolExecutor, GoalExecutor, ImageGenerationExecutor,
        IndexWebpageToolExecutor, InsightRecallExecutor, KnowledgeExecutor,
        LearningOverviewExecutor, LlmUsageToolExecutor, LocalShellExecuteExecutor,
        LocalShellPreflightExecutor, LspNavigationExecutor, McpManageExecutor, McpProposeExecutor,
        MediaToolExecutor, MemoryToolExecutor, OfficeFidelityExecutor, PaperSaveExecutor,
        PptxToolExecutor, PtcExecutor, ReviewToolExecutor, SessionToolExecutor,
        SettingsModelsToolExecutor, SkillLifecycleExecutor, SkillsExecutor, SubagentExecutor,
        TaskAuditExecutor, TemplateDesignerExecutor, TextbookPdfToolExecutor, TodoListExecutor,
        ToolExecutor, ToolPackExecutor, TranslationToolExecutor, UserTodoExecutor,
        WorkbenchToolExecutor, WorkspaceFsExecutor, WorkspaceToolExecutor, XlsxToolExecutor,
    };
