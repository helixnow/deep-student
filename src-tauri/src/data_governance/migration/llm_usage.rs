...
mod tests {
    ...
    fn test_migration_set_structure() {
        ...
        assert_eq!(LLM_USAGE_MIGRATION_SET.count(), 7); // + V20260202 + V20260524 + V20260525 + V20260824
    }
    ...
    fn test_latest_version() {
        assert_eq!(LLM_USAGE_MIGRATION_SET.latest_version(), 20260824);
    }
