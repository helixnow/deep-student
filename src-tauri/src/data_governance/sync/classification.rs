...
pub fn sync_classification_registry() -> Vec<TableClassification> {
    vec![
        ...
        // --- Insight Recall v2（docs/dev/insight-recall/README.md）---
        TableClassification {
            database: "vfs",
            table_name: "insights",
            primary_key: "id",
            ...
            business_unique_keys: "",
            has_json_blobs: false,
            merge_notes: "Insight cards; counters are soft stats (LWW acceptable); single-writer device recommended per spec §7.2",
        },
        TableClassification {
            database: "vfs",
            table_name: "insight_revisions",
            primary_key: "id",
            category: SyncCategory::RowSync,
            conflict_policy: ConflictPolicyClass::NoConflict,
            business_unique_keys: "",
            has_json_blobs: false,
            merge_notes: "Immutable revisions; INSERT-only plus tombstone",
        },
        TableClassification {
            database: "vfs",
            table_name: "insight_evidence",
            primary_key: "id",
            category: SyncCategory::RowSync,
            conflict_policy: ConflictPolicyClass::NoConflict,
            business_unique_keys: "",
            has_json_blobs: false,
            merge_notes: "Append-only evidence spans with quote snapshots",
        },
        TableClassification {
            database: "vfs",
            table_name: "insight_relations",
            primary_key: "id",
            category: SyncCategory::RowSync,
            conflict_policy: ConflictPolicyClass::Lww,
            business_unique_keys: "from_id,to_id,relation_type",
            has_json_blobs: false,
            merge_notes: "Lifecycle relations; withdraw/re-activate via status column",
        },
        TableClassification {
            database: "vfs",
            ...
            business_unique_keys: "",
            has_json_blobs: true,
            merge_notes: "Append-only learning events (three-ledger signals in columns; payload_json opaque)",
        },
        TableClassification {
            database: "vfs",
